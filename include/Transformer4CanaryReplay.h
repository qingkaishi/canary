...
#define	TRANSFORMER4CANARYREPLAY_H

#include "Transformer.h"

class Transformer4CanaryReplay : public Transformer{
private:
...
public:
    ...
    Transformer4CanaryReplay(Module * m, set<Value*> * svs, unsigned psize);
...
#endif	/* TRANSFORMER4CANARYREPLAY_H */
