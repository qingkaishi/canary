...
${OBJECTDIR}/lib/dyckaa/AAAnalyzer.o: lib/dyckaa/AAAnalyzer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/dyckaa/AAAnalyzer.o lib/dyckaa/AAAnalyzer.cpp

${OBJECTDIR}/lib/dyckaa/DyckAliasAnalysis.o: lib/dyckaa/DyckAliasAnalysis.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/dyckaa
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/dyckaa/DyckAliasAnalysis.o lib/dyckaa/DyckAliasAnalysis.cpp

${OBJECTDIR}/lib/dyckaa/Transformer4Replay.o: lib/dyckaa/Transformer4Replay.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/dyckaa
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/dyckaa/Transformer4Replay.o lib/dyckaa/Transformer4Replay.cpp

${OBJECTDIR}/lib/dyckaa/Transformer4Trace.o: lib/dyckaa/Transformer4Trace.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/dyckaa
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/dyckaa/Transformer4Trace.o lib/dyckaa/Transformer4Trace.cpp

${OBJECTDIR}/lib/dyckgraph/DyckGraph.o: lib/dyckgraph/DyckGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/dyckgraph
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/dyckgraph/DyckGraph.o lib/dyckgraph/DyckGraph.cpp

${OBJECTDIR}/lib/dyckgraph/DyckVertex.o: lib/dyckgraph/DyckVertex.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/dyckgraph
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/dyckgraph/DyckVertex.o lib/dyckgraph/DyckVertex.cpp

${OBJECTDIR}/lib/transformer/Transformer.o: lib/transformer/Transformer.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/transformer
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/transformer/Transformer.o lib/transformer/Transformer.cpp

${OBJECTDIR}/lib/wrapper/FunctionWrapper.o: lib/wrapper/FunctionWrapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/lib/wrapper
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/wrapper/FunctionWrapper.o lib/wrapper/FunctionWrapper.cpp
