...
function usage() {
	...
	echo -e ""
	echo -e "Usage:"
	echo -e "  canary.sh -i <bitcode file>"
	echo ""
...
if [ -f "$INPUT_FILE" ]; then
	...
	echo "If you want a record version, please add -lcanaryrecord when you compile it to be an executable file."
